const weatherDescriptions = {
    ...
    "Relative Humidity": "Relative humidity is a quantitative measure of the amount of moisture present in the air, expressed as a percentage of the maximum water vapor that the air could hold at a given temperature. High relative humidity can create a sensation of warmth and discomfort, while low relative humidity can cause dehydration and result in dryness of the skin.",
